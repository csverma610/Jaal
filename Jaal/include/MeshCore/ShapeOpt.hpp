...
public:
    ...
    void removeAreaConstraints()
    {
        cdb.erase("Area");
    }
    void removeEdgeStrainConstraints()
    {
        cdb.erase("EdgeStrain");
    }
    void removeTriangleStrainConstraints()
    {
        cdb.erase("TriangleStrain");
    }
    void removeCircleConstraints()
    {
        cdb.erase("Circle");
    }
    void removePlaneConstraints()
    {
        cdb.erase("Plane");
    }
    void removeLaplaceConstraints()
    {
        cdb.erase("Laplace");
    }
    void removeRectangleConstraints()
    {
        cdb.erase("Rectangle");
    }
    void removeParallelogramConstraints()
    {
        cdb.erase("Parallelogram");
    }
    void removeSimilarityConstraints()
    {
        cdb.erase("Similarity");
    }
    void removeRigidConstraints()
    {
        cdb.erase("Rigid");
    }
    void removeVolumeConstraints()
    {
        cdb.erase("Volume");
    }
    void removeSphereConstraints()
    {
        cdb.erase("Sphere");
    }
    void removeCrossFieldConstraints()
    {
        cdb.erase("CrossField");
    }
