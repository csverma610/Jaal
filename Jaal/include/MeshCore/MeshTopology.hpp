...
public:
    ...
    static void getEntitySet( const JCellSequence &faces, JEdgeSequence &edges);
    ...
    int  isHomogeneous(int dim) const;
    ...
    void get_nonmanifold_edges(JEdgeSequence &seq);
    ...
    void get_ordered_sequence( const JNodePtr &v, JNodeSequence &seq, int ordered,
                               size_t maxSize = INT_MAX);

    void get_ordered_sequence( const JFacePtr &f, JFaceSequence &seq, int ordered,
                               size_t maxSize = INT_MAX );

    void get_ordered_sequence( const JCellPtr &c, JCellSequence &seq, int ordered,
                               size_t maxSize = INT_MAX );
