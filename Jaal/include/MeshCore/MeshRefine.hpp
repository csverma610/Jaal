...
public:
    ...
    void  getNewNodes(JNodeSequence &seq)
    {
        seq = newNodes;
    }
    void  getNewFaces(JFaceSequence &seq)
    {
        seq = newFaces;
    }
...
private:
    ...
    int  refine_vertex_degree3( const JNodePtr &v, const JEdgePtr &edge1, const JEdgePtr &edge2);
    int  refine_vertex_degree4( const JNodePtr &v, const JEdgePtr &edge1);
    int  refine_vertex_degree3( const JNodePtr &v);
    int  refine_vertex_degree4( const JNodePtr &v);
};
////////////////////////////////////////////////////////////////////////////////
