...
public:
    ...
    */
    ...
    std::size_t getIndices() const
    {
        return idI_.size();
    }

    const Matrix3X &getProjectedPoints() const;
...
private:
    ...
    Scalar rangeMin_;
    Scalar rangeMax_;
    void  setTarget(const Matrix3X &positions);
};
///////////////////////////////////////////////////////////////////////////////
...
class  TetrahedronStrainConstraint : public Constraint
{
public:
    /** \brief Constraint constructor.
...
class  ParallelogramConstraint : public Constraint
{
public:
    /** \brief Constraint constructor.
      \param idI Indices of vertices to be projection onto on a sphere.
