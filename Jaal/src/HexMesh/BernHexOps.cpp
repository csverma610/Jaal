...
void JBernHexOps :: getCanonical17( JNodeSequence &newnodes, JCellSequence &newcells)
{
    ...
    JHexahedronPtr hex = Hexahedron::getCanonical();
...
void JBernHexOps :: getCanonical26( JNodeSequence &newnodes, JCellSequence &newcells)
{
    ...
    JQuadrilateralPtr quad1 = Quadrilateral::getCanonical(1.0);
    JQuadrilateralPtr quad2 = Quadrilateral::getCanonical(2.0);
    JQuadrilateralPtr quad3 = Quadrilateral::getCanonical(1.0);
    ...
    newcells[0] = Hexahedron::newObject( quad1, quad2 );
    newcells[1] = Hexahedron::newObject( quad2, quad3 );
}
...
void JBernHexOps :: getCanonical314_5( JNodeSequence &newnodes, JCellSequence &newcells)
{
    ...
    JQuadrilateralPtr quad1 = Quadrilateral::newObject( newnodes[0], newnodes[1],
                              newnodes[2], newnodes[3] );
    JQuadrilateralPtr quad2 = Quadrilateral::newObject( newnodes[0], newnodes[3],
                              newnodes[4], newnodes[5] );
    JQuadrilateralPtr quad3 = Quadrilateral::newObject( newnodes[0], newnodes[5],
                              newnodes[6], newnodes[1] );

    JQuadrilateralPtr quad4 = Quadrilateral::newObject( newnodes[7], newnodes[8],
                              newnodes[9], newnodes[10] );
    JQuadrilateralPtr quad5 = Quadrilateral::newObject( newnodes[7], newnodes[10],
                              newnodes[11], newnodes[12] );
    JQuadrilateralPtr quad6 = Quadrilateral::newObject( newnodes[7], newnodes[12],
                              newnodes[13], newnodes[8] );

    newcells.resize(3);
    newcells[0] = Hexahedron::newObject( quad1, quad4 );
    newcells[1] = Hexahedron::newObject( quad2, quad5 );
    newcells[2] = Hexahedron::newObject( quad3, quad6 );
...
void JBernHexOps :: getCanonical316_5( JNodeSequence &newnodes, JCellSequence &newcells)
{
    ...
    JQuadrilateralPtr quad1 = Quadrilateral::getCanonical(1.0);
    JQuadrilateralPtr quad2 = Quadrilateral::getCanonical(2.0);
    JQuadrilateralPtr quad3 = Quadrilateral::getCanonical(2.0);
    JQuadrilateralPtr quad4 = Quadrilateral::getCanonical(1.0);
    ...
    newcells[0] = Hexahedron::newObject( quad1, quad2 );
    newcells[1] = Hexahedron::newObject( quad2, quad3 );
    newcells[2] = Hexahedron::newObject( quad3, quad4 );
}
...
void JBernHexOps :: getCanonical416_4( JNodeSequence &newnodes, JCellSequence &newcells)
{
    ...
    JQuadrilateralPtr quad1 = Quadrilateral::newObject( newnodes[1], newnodes[7],
                              newnodes[2], newnodes[3] );
    JQuadrilateralPtr quad2 = Quadrilateral::newObject( newnodes[0], newnodes[1],
                              newnodes[3], newnodes[4] );
    JQuadrilateralPtr quad3 = Quadrilateral::newObject( newnodes[0], newnodes[4],
                              newnodes[5], newnodes[6] );
    JQuadrilateralPtr quad4 = Quadrilateral::newObject( newnodes[0], newnodes[6],
                              newnodes[7], newnodes[1] );

    JQuadrilateralPtr quad5 = Quadrilateral::newObject( newnodes[9], newnodes[15],
                              newnodes[10], newnodes[11] );
    JQuadrilateralPtr quad6 = Quadrilateral::newObject( newnodes[8], newnodes[9],
                              newnodes[11], newnodes[12] );
    JQuadrilateralPtr quad7 = Quadrilateral::newObject( newnodes[8], newnodes[12],
                              newnodes[13], newnodes[14] );
    JQuadrilateralPtr quad8 = Quadrilateral::newObject( newnodes[8], newnodes[14],
                              newnodes[15], newnodes[9] );

    newcells.resize(4);
    newcells[0] = Hexahedron::newObject( quad1, quad5 );
    newcells[1] = Hexahedron::newObject( quad2, quad6 );
    newcells[2] = Hexahedron::newObject( quad3, quad7 );
    newcells[3] = Hexahedron::newObject( quad4, quad8 );
}
...
int JBernHexOps::searchPattern_7_1( vector<JHexahedronPtr> &cellseq)
{
    ...
    for( size_t i = currCellID; i < numCells; i++) {
        ...
        bool found = 1;
        for( int j = 0; j < Hexahedron::NumNodes; j++) {
        ...
        if( found )  {
            cellseq.push_back(Hexahedron::down_cast(cell));
            currCellID = i+1;
        }
    }
    return 0;
...
int JBernHexOps::Op1_7( const JHexahedronPtr hex, JNodeSequence &newnodes, JCellSequence &newcells)
{
    ...
    JHexahedronPtr hex0 = Hexahedron::newObject( newnodes);
    ...
    JHexahedronPtr hex1 = Hexahedron::newObject( hexnodes );
    ...
    JHexahedronPtr hex2 = Hexahedron::newObject( hexnodes);
    ...
    hexnodes[7] =  newnodes[4];
    JHexahedronPtr hex3 = Hexahedron::newObject( hexnodes);
    ...
    JHexahedronPtr hex4 = Hexahedron::newObject( hexnodes );
    ...
    hexnodes[7] =  newnodes[3];
    JHexahedronPtr hex5 = Hexahedron::newObject( hexnodes );
    ...
    hexnodes[6] =  newnodes[6];
    hexnodes[7] =  newnodes[7];
    JHexahedronPtr hex6 = Hexahedron::newObject( hexnodes );
