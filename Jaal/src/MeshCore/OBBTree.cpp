                            ...
                            vector<double> &plane)
{
    ...
    Vec3D normal  = TriGeometry::getNormal(p0, p1, p2);
                           ...
                           vector<double> &plane)
{
    ...
    lhex = Hexahedron::newObject( vold[0], v01, v23, vold[3],
    ...
    rhex = Hexahedron::newObject( v01, vold[1], vold[2], v23,
                           ...
                           vector<double> &plane)
{
    ...
    lhex = Hexahedron::newObject( vold[0], vold[1], v12, v03,
    ...
    rhex = Hexahedron::newObject( v03, v12, vold[2], vold[3],
                           ...
                           vector<double> &plane)
{
    ...
    lhex = Hexahedron::newObject( vold[0], vold[1], vold[2], vold[3],
                                  v04, v15, v26, v37 );
    boxes.push_back(lhex);
    ...
    rhex = Hexahedron::newObject( v04, v15, v26, v37,
...
void JOBBTree :: splitHex( const NodePtr &parent)
{
    ...
    JHexahedronPtr hex1 = JMeshGeometry::getMinimumBox(lChild->nodes);
    for( int i = 0; i < 8; i++) {
        const Point3D &xyz = hex1->getNodeAt(i)->getXYZCoords();
        lhex->getNodeAt(i)->setXYZCoords(xyz);
    }

    JHexahedronPtr hex2 = JMeshGeometry::getMinimumBox(rChild->nodes);
    for( int i = 0; i < 8; i++) {
...
JCellSequence JOBBTree :: getBoxes(const JNodeSequence &nodes)
{
    ...
    root->depth = 1;
    root->nodes = nodes;
    root->hex   = JMeshGeometry::getMinimumBox(nodes);
