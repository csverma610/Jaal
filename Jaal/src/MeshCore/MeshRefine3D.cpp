...
int JHexRefiner :: refine18( const JCellPtr &cell, JNodeSequence &newnodes, JCellSequence &newcells)
{
    ...
    const auto hex = JHexahedron::down_cast( cell );
    if( hex == NULL ) return 1;
    if( !cell->isActive() ) return 1;

    auto v0 = hex->getNodeAt(0);
    auto v1 = hex->getNodeAt(1);
    auto v2 = hex->getNodeAt(2);
    auto v3 = hex->getNodeAt(3);
    auto v4 = hex->getNodeAt(4);
    auto v5 = hex->getNodeAt(5);
    auto v6 = hex->getNodeAt(6);
    auto v7 = hex->getNodeAt(7);
...
int JHexRefiner :: refineNode0( const JCellPtr &cell, JNodeSequence &newnodes, JCellSequence &newcells)
{
    ...
    auto v0 = cell->getNodeAt(0);
    auto v1 = cell->getNodeAt(1);
    auto v2 = cell->getNodeAt(2);
    auto v3 = cell->getNodeAt(3);
    auto v4 = cell->getNodeAt(4);
    auto v5 = cell->getNodeAt(5);
    auto v6 = cell->getNodeAt(6);
    auto v7 = cell->getNodeAt(7);
    ...
    auto v14 = JCell::getCentroid( hex );
