...
///////////////////////////////////////////////////////////////////////////////
double JMeshGeometry :: getMeanBoundaryEdgeLength() const
{
...
///////////////////////////////////////////////////////////////////////////////
double JMeshGeometry :: getMaximumDistance( const JMeshPtr &mesh1, const JMeshPtr &mesh2)
{
    size_t numnodes = mesh1->getSize(0);
    if( numnodes != mesh2->getSize(0) )
        cout << "Warning: Two meshes are not same " << endl;
...
JMeshGeometry ::getNumOfInvertedElements() const
{
    ...
    if( topDim == 3 ) {
        ...
        cout << "#Hex with negative Jaco " << nCount << endl;
    }
    return nCount;
}
