...
int JTriRefiner :: refine_vertex_degree3(const JNodePtr &vertex, const JEdgePtr &edge1,
        const JEdgePtr &edge2)
{
    ...
    nodes[4] = Triangle::getOppositeNode(of1, nodes[1], nodes[2] );
    ...
    nodes[5] = Triangle::getOppositeNode(of2, nodes[1], nodes[3]);
    ...
    newFaces[0]  = Triangle::newObject( nodes[1], nodes[4], nodes[6] );
    newFaces[1]  = Triangle::newObject( nodes[2], nodes[6], nodes[4] );
    newFaces[3]  = Triangle::newObject( nodes[1], nodes[7], nodes[5] );
    newFaces[4]  = Triangle::newObject( nodes[3], nodes[5], nodes[7] );
    newFaces[5]  = Triangle::newObject( nodes[0], nodes[10], nodes[2] );
    newFaces[6]  = Triangle::newObject( nodes[2], nodes[10], nodes[6] );
    newFaces[7]  = Triangle::newObject( nodes[0], nodes[3], nodes[11] );
    newFaces[8]  = Triangle::newObject( nodes[3], nodes[7], nodes[11] );
    newFaces[9]  = Triangle::newObject( nodes[0], nodes[11], nodes[8] );
    newFaces[10] = Triangle::newObject( nodes[8], nodes[11], nodes[9] );
    newFaces[11] = Triangle::newObject( nodes[7], nodes[9], nodes[11] );
    newFaces[12] = Triangle::newObject( nodes[1], nodes[9], nodes[7] );
    newFaces[13] = Triangle::newObject( nodes[0], nodes[8], nodes[10] );
    newFaces[14] = Triangle::newObject( nodes[8], nodes[12], nodes[10] );
    newFaces[15] = Triangle::newObject( nodes[8], nodes[9], nodes[12] );
    newFaces[16] = Triangle::newObject( nodes[1], nodes[12], nodes[9] );
    newFaces[17] = Triangle::newObject( nodes[1], nodes[6], nodes[12] );
...
int JTriRefiner :: refine_vertex_degree3(const JNodePtr &vertex)
{
    ...
    for( int i = 0; i < 3; i++) {
        ...
        int err = refine_vertex_degree3(vertex, edge1, edge2);
        if( !err ) return 0;
    }
    return 1;
...
int JTriRefiner :: refine_vertex_degree4(const JNodePtr &vertex, const JEdgePtr &edge)
{
    ...
    for( int i = 0; i < 4; i++)
        edges[i] = Triangle::getOppositeEdge( faceneighs[i], vertex);
    ...
    nodes[5] = Triangle::getOppositeNode( tri2, nodes[1], nodes[2] );
    ...
    newFaces[0] = Triangle::newObject( nodes[3], nodes[0], nodes[7] );
    newFaces[1] = Triangle::newObject( nodes[3], nodes[7], nodes[2]);

    newFaces[2] = Triangle::newObject( nodes[4], nodes[1], nodes[8]);
    newFaces[3] = Triangle::newObject( nodes[4], nodes[8], nodes[0]);

    newFaces[4] = Triangle::newObject( nodes[5], nodes[2], nodes[6]);
    newFaces[5] = Triangle::newObject( nodes[5], nodes[6], nodes[1]);

    newFaces[6] = Triangle::newObject( nodes[2], nodes[9], nodes[6]);
    newFaces[7] = Triangle::newObject( nodes[2], nodes[7], nodes[9]);

    newFaces[8] = Triangle::newObject( nodes[0], nodes[8], nodes[10]);
    newFaces[9] = Triangle::newObject( nodes[0], nodes[10], nodes[7]);

    newFaces[10] = Triangle::newObject( nodes[1], nodes[6], nodes[11]);
    newFaces[11] = Triangle::newObject( nodes[1], nodes[11], nodes[8]);

    newFaces[12] = Triangle::newObject( nodes[6], nodes[9], nodes[11]);
    newFaces[13] = Triangle::newObject( nodes[7], nodes[10], nodes[9]);
    newFaces[14] = Triangle::newObject( nodes[8], nodes[11], nodes[10]);
    newFaces[15] = Triangle::newObject( nodes[9], nodes[10], nodes[11]);
...
int JTriRefiner :: refine_vertex_degree_above_7( const JNodePtr &)
{
    return 1;
}
...
int JTriRefiner :: refine3( const JFacePtr &oldface)
{
    ...
    newNodes[0] = vcenter;
    newFaces.resize(3);
    newFaces[0] = Triangle::newObject(vcenter, v0, v1);
    newFaces[1] = Triangle::newObject(vcenter, v1, v2);
    newFaces[2] = Triangle::newObject(vcenter, v2, v0);
...
int JTriRefiner::refine4( const JFacePtr &oldface)
{
    ...
    newFaces.resize(4);
    newFaces[0] = Triangle::newObject( v0, ev0, ev2 );
    newFaces[1] = Triangle::newObject( v1, ev1, ev0 );
    newFaces[2] = Triangle::newObject( v2, ev2, ev1 );
    newFaces[3] = Triangle::newObject( ev0, ev1, ev2 );
...
int JTriRefiner::refine6( const JFacePtr &oldface)
{
    ...
    newFaces.resize(6);
    newFaces[0] = Triangle::newObject( v0, v1,  ev0 );
    newFaces[1] = Triangle::newObject( v0, ev0, v2 );
    newFaces[2] = Triangle::newObject( v0, v2,  ev1 );
    newFaces[3] = Triangle::newObject( v0, ev1, v3 );
    newFaces[4] = Triangle::newObject( v0, v3,  ev2 );
    newFaces[5] = Triangle::newObject( v0, ev2, v1 );
...
int JTriRefiner:: refine(const JFacePtr &face, const JEdgePtr &edge)
{
    ...
    const JNodePtr &v2 = Triangle::getOppositeNode( face, v0, v1);
    ...
    JFacePtr t1 = Triangle::newObject( v0, vm, v2);
    JFacePtr t2 = Triangle::newObject( vm, v1, v2);
