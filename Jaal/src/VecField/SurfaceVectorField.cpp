...
////////////////////////////////////////////////////////////////////////////////////
bool JSurfaceVectorField :: isPlanar( const JFacePtr &face, const Vec3D &query)
{
...
Vec3F JSurfaceVectorField :: getRandomVector( const JFacePtr &face)
{
    Point3D  pCenter;
...
Eigen::VectorXd JSurfaceVectorField :: genRandomVector(const Eigen::VectorXd& b1,
...
////////////////////////////////////////////////////////////////////////////////////
int JSurfaceVectorField :: readConstraints( const string &file1, const string &file2)
{
// Load constraints
...
////////////////////////////////////////////////////////////////////////////////////
JFaceSequence JSurfaceVectorField :: getConstrainedFaces()
{
...
int JSurfaceVectorField :: readVecField()
{
...
/////////////////////////////////////////////////////////////////////
int JSurfaceVectorField :: saveConstraints()
{
...
void JSurfaceVectorField :: addEdges(const JMeshPtr &vecfield, const MatrixXd &tail, const MatrixXd &head)
{
    int nSize = tail.rows();
    ...
    for( size_t i = 0; i < nSize; i++) {
        ...
        vecfield->addObject(newedge);
    }
}
////////////////////////////////////////////////////////////////////////////////////
JMeshPtr JSurfaceVectorField :: getConstrainedField()
{
