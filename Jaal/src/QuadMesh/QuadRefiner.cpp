...
int JQuadRefiner::refine4( const JFacePtr &oldface)
{
    ...
    newFaces.resize(4);
    newFaces[0] = Quadrilateral::newObject( vcenter, ev3, v0, ev0);
    newFaces[1] = Quadrilateral::newObject( vcenter, ev0, v1, ev1);
    newFaces[2] = Quadrilateral::newObject( vcenter, ev1, v2, ev2);
    newFaces[3] = Quadrilateral::newObject( vcenter, ev2, v3, ev3);
...
int JQuadRefiner::refine5(const JFacePtr &oldface)
{
    ...
    if (QuadGeometry::isConvex(oldface))
...
int JQuadRefiner :: refine( const JFacePtr &oldface)
{
    ...
    for( int j = 0; j < ny-1; j++) {
        for( int i = 0; i < nx-1; i++) {
            ...
            JFacePtr f = Quadrilateral::newObject( v0, v1, v2, v3);
            newFaces[index++] =  f;
        }
    }
...
int JQuadRefiner ::refine15_concave(const JFacePtr &face)
{
    ...
    nodes[2] = newNodes[1];
    nodes[3] = newNodes[0];
    newFaces[0] = Quadrilateral::newObject();
    ...
    nodes[2] = newNodes[2];
    nodes[3] = newNodes[1];
    newFaces[1] = Quadrilateral::newObject();
    ...
    nodes[2] = newNodes[3];
    nodes[3] = newNodes[2];
    newFaces[2] = Quadrilateral::newObject();
    ...
    nodes[2] = newNodes[0];
    nodes[3] = newNodes[3];
    newFaces[3] = Quadrilateral::newObject();
    ...
    nodes[2] = newNodes[2];
    nodes[3] = newNodes[3];
    newFaces[4] = Quadrilateral::newObject();
...
int JQuadRefiner ::refine15_convex(const JFacePtr &face)
{
    ...
    QuadGeometry::bilinear_weights(-1.0 + dl, -1.0 + dl, weight);
    ...
    QuadGeometry::bilinear_weights(-1.0 + 2 * dl, -1.0 + dl, weight);
    xyz[0] = JSimplex::linear_interpolation(xc, weight);
    xyz[1] = JSimplex::linear_interpolation(yc, weight);
    xyz[2] = JSimplex::linear_interpolation(zc, weight);
    newNodes[1] = JNode::newObject();
    ...
    QuadGeometry::bilinear_weights(-1.0 + 2 * dl, -1.0 + 2 * dl, weight);
    xyz[0] = JSimplex::linear_interpolation(xc, weight);
    xyz[1] = JSimplex::linear_interpolation(yc, weight);
    xyz[2] = JSimplex::linear_interpolation(zc, weight);
    newNodes[2] = JNode::newObject();
    ...
    QuadGeometry::bilinear_weights(-1.0 + dl, -1.0 + 2.0 * dl, weight);
    xyz[0] = JSimplex::linear_interpolation(xc, weight);
    xyz[1] = JSimplex::linear_interpolation(yc, weight);
    xyz[2] = JSimplex::linear_interpolation(zc, weight);
    newNodes[3] = JNode::newObject();
    ...
    nodes[2] = newNodes[1];
    nodes[3] = newNodes[0];
    newFaces[0] = Quadrilateral::newObject(nodes);

    nodes[0] = oldNodes[1];
    nodes[1] = oldNodes[2];
    nodes[2] = newNodes[2];
    nodes[3] = newNodes[1];
    newFaces[1] = Quadrilateral::newObject(nodes);

    nodes[0] = oldNodes[2];
    nodes[1] = oldNodes[3];
    nodes[2] = newNodes[3];
    nodes[3] = newNodes[2];
    newFaces[2] = Quadrilateral::newObject(nodes);

    nodes[0] = oldNodes[3];
    nodes[1] = oldNodes[0];
    nodes[2] = newNodes[0];
    nodes[3] = newNodes[3];
    newFaces[3] = Quadrilateral::newObject(nodes);

    nodes[0] = newNodes[0];
    nodes[1] = newNodes[1];
    nodes[2] = newNodes[2];
    nodes[3] = newNodes[3];
    newFaces[4] = Quadrilateral::newObject(nodes);
...
int JQuadRefiner :: refine2( const JFacePtr &oldface)
{
    ...
    if( attrib[0] && attrib[1] ) {
        ...
        newFaces.resize(3);
        newFaces[0] = Quadrilateral::newObject(v0, v4, v6, v3);
        newFaces[1] = Quadrilateral::newObject(v1, v5, v6, v4);
        newFaces[2] = Quadrilateral::newObject(v2, v3, v6, v5);
    }
    ...
    if( attrib[1] && attrib[2] ) {
        ...
        newNodes.push_back(v6);
        newFaces.resize(3);
        newFaces[0] = Quadrilateral::newObject(v0, v1, v4, v6);
        newFaces[1] = Quadrilateral::newObject(v2, v5, v6, v4);
        newFaces[2] = Quadrilateral::newObject(v3, v0, v6, v5);
    }
    ...
    if( attrib[2] && attrib[3] ) {
        ...
        newNodes.push_back(v6);
        newFaces.resize(3);
        newFaces[0] = Quadrilateral::newObject(v0, v1, v6, v5);
        newFaces[1] = Quadrilateral::newObject(v1, v2, v4, v6);
        newFaces[2] = Quadrilateral::newObject(v3, v5, v6, v4);
    }
    ...
    if( attrib[0] && attrib[3] ) {
        ...
        newNodes.push_back(v6);
        newFaces.resize(3);
        newFaces[0] = Quadrilateral::newObject(v0, v4, v6, v5);
        newFaces[1] = Quadrilateral::newObject(v1, v2, v6, v4);
        newFaces[2] = Quadrilateral::newObject(v2, v3, v5, v6);
    }
...
int JQuadRefiner :: refine3( const JFacePtr &face )
{
    ...
    if( edge0 ->hasAttribute("Steiner") ) {
        ...
        paramCoords[0] = 0.5;
        paramCoords[1] = 0.0;
        QuadGeometry::getBilinearCoords( face,  paramCoords, xyz);
        v6->setXYZCoords(xyz);
        ...
        f0 = Quadrilateral::newObject(v0, v4, v7, v3);
        f1 = Quadrilateral::newObject(v1, v2, v6, v5);
        f2 = Quadrilateral::newObject(v2, v3, v7, v6);
        f3 = Quadrilateral::newObject(v4, v5, v6, v7);
    ...
    if( edge1 ->hasAttribute("Steiner") ) {
        ...
        newNodes.push_back(v6);
        newNodes.push_back(v7);
        f0 = Quadrilateral::newObject(v0, v1, v4, v7);
        f1 = Quadrilateral::newObject(v2, v3, v6, v5);
        f2 = Quadrilateral::newObject(v0, v7, v6, v3);
        f3 = Quadrilateral::newObject(v4, v5, v6, v7);
    ...
    if( edge2 ->hasAttribute("Steiner") ) {
        ...
        f0 =  Quadrilateral::newObject(v0, v1, v7, v6);
        f1 =  Quadrilateral::newObject(v2, v4, v7, v1);
        f2 =  Quadrilateral::newObject(v3, v0, v6, v5);
        f3 =  Quadrilateral::newObject(v4, v5, v6, v7);
    ...
    if( edge3 ->hasAttribute("Steiner") ) {
        ...
        f0 =  Quadrilateral::newObject(v0, v1, v7, v5);
        f1 =  Quadrilateral::newObject(v1, v2, v6, v7);
        f2 =  Quadrilateral::newObject(v2, v3, v4, v6);
        f3 =  Quadrilateral::newObject(v4, v5, v7, v6);
...
*/
    ...
    for( size_t i = 0; i < boundEdges.size(); i++) {
        ...
        assert(v2);
        assert(v3);
        JQuadrilateralPtr q = Quadrilateral::newObject(v0,v1,v2,v3);
