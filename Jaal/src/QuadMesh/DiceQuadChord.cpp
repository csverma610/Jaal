...
void JDiceQuadChord :: edge1( const JFacePtr &face)
{
    ...
    newfaces[0] = Quadrilateral::newObject(nodes[0], nodes[1], nodes[4], nodes[6] );
    newfaces[1] = Quadrilateral::newObject(nodes[1], nodes[2], nodes[5], nodes[4] );
    newfaces[2] = Quadrilateral::newObject(nodes[2], nodes[3], nodes[7], nodes[5] );
    newfaces[3] = Quadrilateral::newObject(nodes[4], nodes[5], nodes[7], nodes[6] );
...
void JDiceQuadChord :: edge2( const JFacePtr &face)
{
    ...
    case 20:
        ...
        newfaces.push_back(Quadrilateral::newObject(nodes[0], nodes[1], nodes[5], nodes[4] ));
        newfaces.push_back(Quadrilateral::newObject(nodes[1], nodes[2], nodes[6], nodes[5] ));
        newfaces.push_back(Quadrilateral::newObject(nodes[2], nodes[3], nodes[7], nodes[6] ));
        break;
    case 31:
        nodes[0] = v0;
        nodes[1] = v1;
        ...
        newfaces.push_back( Quadrilateral::newObject(nodes[0], nodes[1], nodes[3], nodes[2] ));
        newfaces.push_back( Quadrilateral::newObject(nodes[2], nodes[3], nodes[5], nodes[4] ));
        newfaces.push_back( Quadrilateral::newObject(nodes[4], nodes[5], nodes[7], nodes[6] ));
        break;
    default:
        ...
        newfaces.push_back( Quadrilateral::newObject(nodes[0], nodes[1], nodes[4], nodes[9] ));
        newfaces.push_back( Quadrilateral::newObject(nodes[1], nodes[2], nodes[5], nodes[4] ));
        newfaces.push_back( Quadrilateral::newObject(nodes[2], nodes[3], nodes[6], nodes[5] ));
        newfaces.push_back( Quadrilateral::newObject(nodes[5], nodes[6], nodes[8], nodes[7] ));
        newfaces.push_back( Quadrilateral::newObject(nodes[7], nodes[8], nodes[10], nodes[9]));
        newfaces.push_back( Quadrilateral::newObject(nodes[4], nodes[5], nodes[7], nodes[9]));
        mesh->addObject(nodes[4]);
        mesh->addObject(nodes[5]);
...
void JDiceQuadChord :: edge3( const JFacePtr &face)
{
    ...
    newfaces[0]  = Quadrilateral::newObject( nodes[0],  nodes[1],  nodes[5],  nodes[4] );
    newfaces[1]  = Quadrilateral::newObject( nodes[1],  nodes[2],  nodes[6],  nodes[5] );
    newfaces[2]  = Quadrilateral::newObject( nodes[2],  nodes[3],  nodes[7],  nodes[6] );
    newfaces[3]  = Quadrilateral::newObject( nodes[4],  nodes[5],  nodes[9],  nodes[8] );
    newfaces[4]  = Quadrilateral::newObject( nodes[5],  nodes[6],  nodes[10], nodes[9] );
    newfaces[5]  = Quadrilateral::newObject( nodes[6],  nodes[7],  nodes[11], nodes[10] );
    newfaces[6]  = Quadrilateral::newObject( nodes[8],  nodes[9],  nodes[13], nodes[12] );
    newfaces[7]  = Quadrilateral::newObject( nodes[9],  nodes[10], nodes[14], nodes[13] );
    newfaces[8]  = Quadrilateral::newObject( nodes[10], nodes[11], nodes[15], nodes[14] );
    newfaces[9]  = Quadrilateral::newObject( nodes[0],  nodes[4],  nodes[8],  nodes[12] );
...
void JDiceQuadChord :: edge4( const JFacePtr &face)
{
    ...
    for( int j = 0; j < 3; j++) {
        for( int i = 0; i < 3; i++) {
            ...
            newfaces[index++] = Quadrilateral::newObject(v0,v1,v2,v3);
        }
    }
