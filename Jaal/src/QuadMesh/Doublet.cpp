...
JDoublet::remove( const JNodePtr &v0)
{
    ...
    JFacePtr qface = Quadrilateral::newObject( v1, o1, v2, o2);
...
JDoublet::insert(const JFacePtr &face, const JNodePtr &v0, const JNodePtr &v2)
{
    ...
    JFacePtr newquad1 = Quadrilateral::newObject( doublet, v0, v1, v2);
    mesh->addObject(newquad1);

    JFacePtr newquad2 = Quadrilateral::newObject( doublet, v2, v3, v0 );
